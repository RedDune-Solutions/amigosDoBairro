...
const RANK_BRONZE = "linear-gradient(135deg,#EFCBA8,#CE9A6B 65%,#A06E42)";
...
function RankBadge({ rank }: { rank: number }) {
  ...
  if (rank === 3) return <div style={{ ...base, background: RANK_BRONZE, color: "#5F3F21", boxShadow: "0 4px 10px -3px rgba(160,110,66,.5)" }}>3</div>;
